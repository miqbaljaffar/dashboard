...
export default function AcademiaView({
  ...
  // Inline editing states for items (Grade Columns)
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wider flex items-center gap-1.5">
            ...
            Nilai Akademik Kuis & Ulangan
          </h2>
          <p className="text-[10px] text-slate-500 mt-0.5">Kelola kolom kuis, ujian, dan penginputan nilai trainee</p>
        </div>
